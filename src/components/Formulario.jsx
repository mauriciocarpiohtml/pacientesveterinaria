...
function Formulario( {pacientes, setPacientes, paciente, setPaciente} ) {
  ...
  // clave la propiedad object keys porque si no va a setear el formulario con un objeto 
  //que aun no existe y me va a marcar el estado como undefined
  useEffect(()=>{
  ...
  return (
    <div className='w-full lg:w-1/2 mx-auto '>
        ...
        className='bg-white p-5 mt-10 rounded-lg shadow-lg mb-20 '>
            
            {/* si mensajeError existe entonces muestrame el componente de error */}
